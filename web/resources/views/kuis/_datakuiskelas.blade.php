  ...
  @endforeach
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Data Kuis Kelas</h3>
                ...
                <td>
                  ...
                  <div class="modal fade" id="modal-nilai{{ $item->id }}">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title">Nilai Kuis</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="modal fade" id="modal-edit{{ $item->urut }}">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form action="{{ route('simpaneditkuis') }}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-body">
                      ...
                      <div class="container">
                        ...
                        <div class="form-group">
                          <label for="mulai">Mulai Kerjakan</label>
                          <input type="time" name="mulai" class="form-control" value="{{ date('H:i:s', strtotime($item->mulai)) }}" id="mulai">
                        </div>          
                        <div class="form-group">
                            <label for="deadline">Deadline</label>
                            <input type="time" name="deadline" class="form-control" value="{{ date('H:i:s', strtotime($item->selesai)) }}" id="deadline">
                        </div>     
                      </div>
                    </div>
                    <div class="modal-footer justify-content-between">
            ...
            <div class="modal fade" id="modal-hapus{{ $item->urut }}">
              <div class="modal-dialog">
                <div class="modal-content bg-danger">
                  <div class="modal-header">
                    <h4 class="modal-title">Hapus Data Kuis</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <form action="{{ route('hapuskuis') }}" method="post">
                      {{ csrf_field() }}
                      <input type="hidden" name="idmapel" value="{{ $item->mapel }}">
                      <input type="hidden" name="idurut" value="{{ $item->urut }}">
                      <div class="modal-body">
