...
<div class="col-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Ujian Pelajaran {{ $pelajaran }}</h3>
          ...
          <thead>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form action="{{ route("ujiankelas", ['idjadwal' => $item->id]) }}" method="get">
                      {{ csrf_field() }}
                      <input type="hidden" name="id" value="{{ $item->id }}">
                      <input type="hidden" name="idmapel" value="{{ $item->idmapel }}">
                      <input type="hidden" name="idkelas" value="{{ $item->idkelas }}">
                      <button type="submit" value="Tugas" name="" class="btn btn-info">Ujian</button>
                  </form>
                </td>
              </tr>
