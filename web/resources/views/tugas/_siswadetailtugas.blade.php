...
<div class="col-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Kuis Ke-{{ $datatugas->urut }} {{ $datatugas->nama_mapel }}</h3>
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form action="{{ route('kumpultugas') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-lg-3">
                    <input type="file" name="file_tugas" class="form-control form-group" id="">
                </div>
                <div class="col-lg-9">
