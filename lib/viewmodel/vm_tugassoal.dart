...
class TugasSoalVM {
  Future getTugasSoal(String siswa, String mapel, String stat) async {
    try {
      http.Response hasil = await http.get(
          Uri.parse("${VariableAPK.url}apilisttugas/$siswa/$mapel/$stat"),
          headers: {"Accept": "application/json"});
      if (hasil.statusCode == 200) {
        print("data category success");
        print(hasil.body);
        final data = getSoalTugasFromJson(hasil.body);
        return data;
      } else {
