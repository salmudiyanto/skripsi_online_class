...
import 'package:smpn2parepare/page/TampilSoalKuis.dart';
import 'package:smpn2parepare/page/TugasList.dart';

class KuisListCard extends StatelessWidget {
  final int nomor;
  final String id;
  final String nama;
  const KuisListCard({
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => TampilSoalKuis(idSoal: id)));
        },
        child: Container(
          ...
          child: ListTile(
              ...
              subtitle: Row(
                children: <Widget>[
                  ...
                  Text("Kuis", style: TextStyle(color: Colors.white))
                ],
              ),
