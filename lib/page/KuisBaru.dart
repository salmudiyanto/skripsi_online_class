...
class KuisScreenBaru extends StatefulWidget {
  const KuisScreenBaru({super.key});

  @override
  State<KuisScreenBaru> createState() => KuisScreenState();
}

class KuisScreenState extends State<KuisScreenBaru> {
  bool load = true;
  List mapelJson = [];
  int idSiswa = 0;
