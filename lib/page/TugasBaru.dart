...
class TugasScreenBaru extends StatefulWidget {
  const TugasScreenBaru({super.key});

  @override
  State<TugasScreenBaru> createState() => KuisScreenState();
}

class KuisScreenState extends State<TugasScreenBaru> {
  bool load = true;
  List mapelJson = [];
  int idSiswa = 0;
